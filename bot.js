...
class Bot extends Agent {
     ...
     */
    getConsumerProfile (conversationId, conversationDetails, callback) {
        ...
        this.getUserProfile(consumerId, (e, resp) => {
            if (e) log.error(`[bot.js] getConsumerProfile: ${JSON.stringify(e)}`);
                ...
                this.myConversations[conversationId].consumerProfile = resp;
    ...
    _updateMyConversation (conversationId, result) {
        ...
        let _newData = {
            ...
            watsonContext: _oldData.watsonContext
        };
